...
CMD java -XX:+PrintFlagsFinal $JAVA_OPTIONS -cp '/home/sunbird/cert-service-1.2.0/lib/*' -Dlog4j2.formatMsgNoLookups=true -Dlogger.file=/home/sunbird/cert-service-1.2.0/config/logback.xml play.core.server.ProdServerStart  /home/sunbird/cert-service-1.2.0
